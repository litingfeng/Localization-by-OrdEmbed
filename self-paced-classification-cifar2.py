"""
noisy data are randomly rotated to 90, 180, 270 degree
...
if __name__ == "__main__":
    ...
    mode = 'half_half'
    saveroot = os.path.join('/research/cbim/vast/tl601/results/selfpaced/rot50', mode)
    os.makedirs(saveroot, exist_ok=True)

    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    dataset = myCIFAR(root = '.', subset = mode, ratio=0.5,
                      datapath='.',

...
def feed_data(model, data_loader, is_train):
    ...
    train_losses, losses_0, losses_i, losses_order = \
        [], [], [], []
    correct_0, correct_i, correct_order, correct_order_l, \
    correct_order_sub = 0, 0, 0, 0, 0
    ...
    for batch_idx, (ai, aj, x0s,
        ...
        if args.norm == 1:
            ...
            feature_j = F.normalize(feature_j, p=2, dim=1)
    ...
    acc_l = 100. * correct_order_l / len(data_loader.dataset)

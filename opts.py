...
parser.add_argument('--margin', default=60., type=float,
                    help='margin of loss')
parser.add_argument('--sample_size', default='whole', type=str,
                    #choices=['50', '100', '300', '600', '1k', '2k', '3k', '4k','whole'],
                    help='Sample size of train set')
parser.add_argument('-b', '--batch_size', default=512, type=int,
                    help='mini-batch size (default: 256)')
parser.add_argument('--steps', type=int, default=80, nargs='+',
                    help='steps of multistep scheduler')
parser.add_argument('--steps_ag', default=80, type=int,
                    help='scheduler step')
...
parser.add_argument('--num_act', default=14, type=int,

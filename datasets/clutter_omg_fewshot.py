...
class OmniglotDataset(data.Dataset):
    ...
    def __init__(self, root, anchors,mode='train', bg_name='clutter', transform=None,
        ...
        # print('self.classes ', len(self.classes), self.classes[0])
    ...
    def __getitem__(self, idx):
        ...
        return img, target, np.stack((ti, tj)), np.array([iou1, iou2]) #ti, tj, iou1, iou2
...
if __name__ == "__main__":
    ...
    trainset = OmniglotDataset(anchors=anchors, mode='train', bg_name='patch',
                              root='/research/cbim/vast/tl601/Dataset/Omniglot')
    sampler = init_sampler(5, 5, trainset.y[:,-1], 10, 'train')

...
class RandomHorizontalFlip(object):
    ...
    numpy.ndarray
        ...
        number of bounding boxes and ToPercentCoords4 represents `x1,y1,x2,y2` of the box
...
class RandomScale(object):
    ...
    def __call__(self, img, bboxes):
        ...
        bboxes[:,:4] *= np.array([resize_scale_x, resize_scale_y, resize_scale_x, resize_scale_y])
...
class RandomTranslate(object):
    ...
    Bounding boxes which have an area of less than 25% in the remaining in the 
    transformed image is dropped, keep original box and image. The resolution
    is maintained, and the remaining area if any is filled by black color.
...
#        canvas[orig_box_cords[0]:orig_box_cords[2], orig_box_cords[1]:orig_box_cords[3],:] = mask
        ...
        new_bboxes[:,:4] = bboxes[:, :4] + [corner_x, corner_y, corner_x, corner_y]
        
        
        new_bboxes = clip_box(new_bboxes, [0,0,img_shape[1], img_shape[0]], 0.25)

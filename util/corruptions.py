"""
https://raw.githubusercontent.com/google-research/mnist-c/master/corruptions.py
Created on 5/14/2021 3:13 PM
...
with open("/research/cbim/vast/tl601/projects/selfpaced/util/pessimal_noise_matrix", "rb") as f:
...
def fog(x, severity=5):
    ...
    x = np.array(x) / 255.
    max_val = x.max()
    x = x + c[0] * plasma_fractal(wibbledecay=c[1])[:84, :84]

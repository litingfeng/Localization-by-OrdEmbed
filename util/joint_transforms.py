"""
https://github.com/fl16180/small-object-detection/blob/68368bf68b2375041dbeef50669fb0407fbf90f8/utils/joint_transforms.py
...
class ToTensor(object):
    ...
    def __call__(self, image, boxes=None, labels=None):
        ...
        labels = torch.LongTensor(labels) if labels is not None else labels
        return image, boxes, labels

...
def evaluate(net, dataloader):
    ...
    #plot_embedding(embed, targets, probs, acc, dataset, trans=False)
    #plot_embedding(embed_new, targets, probs_new, acc_new, dataset, trans=True)
    return acc

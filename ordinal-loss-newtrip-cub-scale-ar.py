...
from datasets.cub import CUB_OneClass
...
def init_dataloader():
    ...
    trainset = CUB_OneClass('/research/cbim/vast/tl601/Dataset',
    ...
    testset = CUB_OneClass('/research/cbim/vast/tl601/Dataset',
                            category=list(range(2, 3)),
                            anchors=anchors,
                            transform=t.Compose([
                                t.ConvertFromPIL(),
                                t.ToPercentCoords(),
